...
const START_LEVEL : String = "res://levels/lands/01.tscn"

@export var music : AudioStream
@export var button_focus_audio : AudioStream
@export var button_press_audio : AudioStream

@onready var button_new: Button = $CanvasLayer/Control/NewButton
@onready var button_continue: Button = $CanvasLayer/Control/ContinueButton
...
func _ready() -> void:
	...
	await $CanvasLayer/SplashScene.finished
	setup_title_screen()
