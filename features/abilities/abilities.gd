...
const BOOMERANG = preload( "res://features/abilities/boomerang/boomerang.tscn" )

enum abilities { BOOMERANG, GRAPPLE}

var selected_ability = abilities.BOOMERANG
var player : Player
var boomerang_isntance : Boomerang = null
