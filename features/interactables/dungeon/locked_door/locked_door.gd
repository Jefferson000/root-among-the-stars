...
@export var key_item : ItemData #What item can open me
...
func _on_area_enter( _a : Area2D ) -> void:
	PlayerManager.interact_pressed.connect( _open_door )
	pass

func _on_area_exit( _a : Area2D ) -> void:
	PlayerManager.interact_pressed.disconnect( _open_door )
